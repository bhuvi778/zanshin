...
const films=[
  ...
  {slug:'magnetized',name:'Magnetized',number:'04',accent:'#a6485d',film:'/films/magnetized-campaign.mp4',poster:'/films/magnetized-poster.png',heroFilm:'/films/magnetized-hero.mp4',heroPoster:'/films/magnetized-hero-poster.png',kicker:'Confidence / Presence / Attraction',hero:'When you stop asking<br/><em>to be seen.</em>',heroCopy:'Presence becomes magnetic when it no longer needs to perform.',before:'One last moment of hesitation.',after:'Then her own presence becomes enough.',title:'Confidence can be quiet.',story:'Magnetized begins when you stop measuring yourself through the room and move through it as entirely your own. Quiet certainty becomes a presence people can feel.',moment:'For the night when you want to feel unmistakably yourself.'}
];
